...
browser.find_element(
    "xpath",
    '//*[@id="__next"]/div/div[1]/div/div/div[2]/div/div[2]/div/div[2]/form/fieldset/div[1]/div/input',
).send_keys("무선마우스")

# 검색 버튼 클릭
browser.find_element(
    "xpath",
    '//*[@id="__next"]/div/div[1]/div/div/div[2]/div/div[2]/div/div[2]/form/fieldset/div[1]/div/button[2]',
).click()
...
# 화면 가장 아래로 스크롤 내리기
# 화면이 최대화 되지 않은 상태에서는 동작이 다르게 이루어짐 -> 한번에 모두 로딩 후 웹페이지 가장 하단으로 이동함
